...
| Nulis | api/nulis?text=Wahidganteng&apikey=MASUKIN_APIKEY |
...
| Info NPM | api/infonpm?query=WHMODS-api&hostname=WHMODS&apikey=MASUKAN_APIKEY |
...
| Text Maker Coffee Cup | api/textmaker/senja?text=WHMODS&theme=coffee-cup&apikey=MASUKIN_APIKEY |
| Text Maker Coffee Cup 2 | api/textmaker/senja?text=WHMODS&theme=coffee-cup2&apikey=MASUKIN_APIKEY |
| Text Maker Neon | api/textmaker/metallic?text=WHMODS&theme=neon&apikey=MASUKIN_APIKEY |
| Text Maker Glow | api/textmaker/metallic?text=WHMODS&theme=glow&apikey=MASUKIN_APIKEY |
| Text Maker Summer | api/textmaker/alam?text=WHMODS&theme=summer&apikey=MASUKIN_APIKEY |
| Text Maker Flower | api/textmaker/alam?text=WHMODS&theme=flower&apikey=MASUKIN_APIKEY |
