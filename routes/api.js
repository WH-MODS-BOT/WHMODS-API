...
try {
var zahirr = db.get("WHMODS");
} catch (e) {
	console.log('')
}

var creatorList = ['@W4H1D','@WHMODS','@MRW4H1D','@WAHIDGANS', '@WHGANS','@W4H1DG4NS','@WAHIDGANTENG'];
...
loghandler = {
    notparam: {
        ...
        getApikey: 'gak punya apikey? chat gw aja yaaa di wa.me/6282127487538 , key nya gratis kok gan, jadi santuyy ajaa'
    },
    notkey: {
        status: false,
        creator: `${creator}`,
    ...
    invalidKey: {
        ...
        creator: `${creator}`,
        code: 406,
        message: 'apikey invalid, gak punya apikey? chat gw aja yaaa di wa.me/6282127487538 , key nya gratis kok gan, jadi santuyy ajaa'
    },
    invalidlink: {
        status: false,
        creator: `${creator}`,
...
var len = 15
        ...
        var randomTextNumber = random+randomlagi+'---------Wahidgans'+'WAHID--GANS';
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'w4h1dbotgans') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'w4h1dbotgans') return res.json(loghandler.invalidKey)
